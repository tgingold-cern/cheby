...
module repeat_indexing1
  ...
  always @(wr_adr_d0, wr_req_d0, chan_0_ctrl_wack, chan_1_ctrl_wack, chan_2_ctrl_wack, chan_3_ctrl_wack)
  begin
  ...
  always @(wb_adr_i, rd_req_int, chan_0_ctrl_reg, itf[0].status, chan_1_ctrl_reg, itf[1].status, chan_2_ctrl_reg, itf[2].status, chan_3_ctrl_reg, itf[3].status)
  begin
