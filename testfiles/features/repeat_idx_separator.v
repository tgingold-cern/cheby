...
module repeat_idx_separator
  ...
  always @(wr_adr_d0, wr_req_d0, rep0_0_r_wack, rep0_1_r_wack, rep10_r_wack, rep11_r_wack, rep2-0_r_wack, rep2-1_r_wack)
  begin
    rep0_0_r_wreq = 1'b0;
    rep0_1_r_wreq = 1'b0;
    rep10_r_wreq = 1'b0;
  ...
  always @(wb_adr_i, rd_req_int, rep0_0_r_reg, rep0_1_r_reg, rep10_r_reg, rep11_r_reg, rep2-0_r_reg, rep2-1_r_reg)
  begin
