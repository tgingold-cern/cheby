...
module reuse_submap2
  ...
  always @(wr_adr_d0, wr_req_d0, leaf_0_ctrl_wack, leaf_1_ctrl_wack)
  begin
  ...
  always @(wb_adr_i, rd_req_int, leaf_0_leaf_ctrl_enable_reg, leaf_0_leaf_ctrl_mode_reg, leaf_0_leaf_ctrl_divisor_reg, top.leaf[0].status_ready, top.leaf[0].status_count, leaf_1_leaf_ctrl_enable_reg, leaf_1_leaf_ctrl_mode_reg, leaf_1_leaf_ctrl_divisor_reg, top.leaf[1].status_ready, top.leaf[1].status_count)
  begin
