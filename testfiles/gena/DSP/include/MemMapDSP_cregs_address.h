...
#define test7                                              (0x02000001)// register-data, r  , unsigned int
#define test7_b31                                          (0x80000000) // bit-field-data
#define test7_b31ShiftPoz                                  (31) // bit-field-data shift poZzition
#define test5                                              (0x02000002)// register-data, rw , unsigned int
#define test5_b31                                          (0x80000000) // bit-field-data
#define test5_b31ShiftPoz                                  (31) // bit-field-data shift poZzition
//not implemented ctype for test3: bit_encoding = unsigned, el_width = 64
#define test3_b31                                          (0x80000000) // bit-field-data
#define test3_b31ShiftPoz                                  (31) // bit-field-data shift poZzition
