...
Values in --gen-const for vhdl are now printed using std_logic_vector instead of natural.  This is an incompatibility introduced to fix incorrect generated code when a value is too large.
