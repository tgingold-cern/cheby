...
Registers and fields declared with `type: signed` are now generated as
`logic signed [...]` in the SystemVerilog output.  The VHDL and plain
Verilog backends are unchanged.
